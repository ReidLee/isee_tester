...
#define TAG "TEE_ENV_CHECKER"



#define LOG(level, format, ...)                                                 \
do {                                                                            \
    printf("[%s][%s]%s[%d]:",TAG, level, __FUNCTION__, __LINE__);           \
...
do {                                                                                \
    printf("\033[43;33;1m [%s][%s]%s[%d]:",TAG, level, __FUNCTION__, __LINE__);\
    printf(format, ##__VA_ARGS__);                                                  \
    printf(" \033[0m\n");                                                           \
} while(0)
...
do {                                                                                \
    printf("\033[38m [%s][%s]%s[%d]:",TAG, level, __FUNCTION__, __LINE__);\
    printf(format, ##__VA_ARGS__);                                                  \
    printf(" \033[0m\n");                                                           \
} while(0)
...
do {                                                                            \
    printf("\033[31m [%s][%s]%s[%d]:",TAG, level, __FUNCTION__, __LINE__);                 \
    printf(format, ##__VA_ARGS__);                                              \
    printf(" \033[0m\n");                                                               \
} while(0)
...
#define LOG_GREEN(format, ...)  LOG_GREEN_TPL("GREEN", format, ##__VA_ARGS__);
#define LOG_SUCCESS(format, ...) LOG_GREEN_TPL("SUCCESS", format, ##__VA_ARGS__);
